...
export interface LetterGlitchProps {
	...
	smooth?: boolean
	bgColor?: { dark: string; light: string } | string
}
...
export const LetterGlitch = ({
	...
	useEffect(() => {
		...
		if (isDarkMode) {
			fillColor.current = bgColor.dark
		} else {
			fillColor.current = bgColor.light
		}
	}, [isDarkMode])
	...
	return (
		<div className="relative h-full min-h-[100vh] w-full min-w-[100vw] overflow-hidden bg-black">
