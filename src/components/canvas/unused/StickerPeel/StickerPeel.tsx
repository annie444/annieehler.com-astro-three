...
const StickerPeel: React.FC<StickerPeelProps> = ({
  ...
  return (
    <div
      className={`absolute transform-gpu cursor-grab active:cursor-grabbing ${className}`}
      ref={dragTargetRef}
      style={cssVars}
    >
      <style
      ...
      <div
        className="sticker-container relative touch-none select-none sm:touch-auto"
        ref={containerRef}
        style={{
      ...
      >
        ...
        <div
          className="absolute top-4 left-2 h-full w-full opacity-40"
